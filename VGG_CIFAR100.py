...
train_generator = train_datagen.flow_from_directory('C:/Users/jaishah24794/Downloads/CIFAR100/TRAIN',
                                                    target_size=(224, 224),
                                                    batch_size=16,
...
test_generator = test_datagen.flow_from_directory('C:/Users/jaishah24794/Downloads/CIFAR100/TEST',
                                                        target_size=(224, 224),
                                                        batch_size=16,
                                                        class_mode='categorical',
                                                        shuffle=False)
